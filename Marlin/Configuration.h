...
#define STRING_CONFIG_H_AUTHOR "(Phuc LeHong, A8 RAMPS)" // Who made the changes.
 ...
 */
  ...
  #define PROBE_PT_1_Y 177.5
  #define PROBE_PT_2_X 45
  #define PROBE_PT_2_Y 42.5
  #define PROBE_PT_3_X 165
  #define PROBE_PT_3_Y 42.5
#endif
